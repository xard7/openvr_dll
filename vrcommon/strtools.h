...
#if defined( OSX ) || defined( LINUX ) || defined( DEF_WIN32 )
#include <strings.h>
inline int stricmp(const char *pStr1, const char *pStr2) { return strcmp(pStr1,pStr2); }
#define _stricmp stricmp
inline int strnicmp( const char *pStr1, const char *pStr2, size_t unBufferLen ) { return strncmp( pStr1,pStr2, unBufferLen ); }
...
#if defined( _WIN32 ) && _MSC_VER < 1800 && DEPRECATED
